...
package FSNovask
{
    ...
    public class Settings
    {
        ...
        {
            Debug.out.log("URL Loader complete");
                ...
                switch(settingNameAndValue[0])
                {
                    case _fontSize:
                        ...
                        if(!isNaN(parsedFontSize))
                        {
                            ...
                            Debug.out.log("Set FontSize to " + this.FontSize);
                        }
                        break;
                    case _fontSizeLarge:
                        parsedFontSize = Number(settingNameAndValue[1]);
                        if(!isNaN(parsedFontSize))
                        {
                            ...
                            Debug.out.log("Set FontSizeLarge to " + this.FontSizeLarge);
                        }
                        break;
                    case _levelColorDefaultOn:
                        ...
                        Debug.out.log("Set LevelColorDefaultOn to " + this.LevelColorDefaultOn);
                        break;
                }
            }
        }
